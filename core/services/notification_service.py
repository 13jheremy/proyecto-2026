...
class FCMNotificationService:
    ...
    def send_notification(
        ...
        """
        Enviar notificación push básica a un token específico
        ...
        try:
            ...
            logger.error(f"Error de Firebase al enviar notificación: {e}")
            return False
        except Exception as e:
    ...
    def send_multicast_notification(
        ...
        try:
            ...
            logger.info(f"Notificación multicast enviada. Éxitos: {response.success_count}, Fallos: {response.failure_count}")
...
def send_simple_notification(user_token: str, title: str, body: str, data: Optional[Dict] = None) -> bool:
...
def send_oil_change_notification(user_token: str, moto_info: str, kilometraje: int) -> bool:
